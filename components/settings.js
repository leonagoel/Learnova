      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-8">
          <div>
            ...
            <p className="text-white/60">Customize your learning experience and account preferences</p>
          </div>
          ...
          <div className="lg:col-span-3 space-y-6">
            {activeSection === "profile" && (
              <>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center space-x-6">
                      <div className="relative">
                        ...
                        <div
                          className={`w-20 h-20 rounded-full border-2 border-white/20 bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white font-bold text-xl ${getUserPhoto() ? "hidden" : "flex"}`}
                        >
                ...
                <SettingCard title="Account Security" description="Manage your password and security settings">
                  <div className="space-y-4">
                    <div>
            ...
            {activeSection === "notifications" && (
              <SettingCard
                ...
                description="Choose how you want to be notified about your learning progress"
              >
                <div className="space-y-2">
                  ...
                  />
                  <ToggleSwitch
                    enabled={settings.notifications.courseReminders}
                    onChange={(value) => updateSetting("notifications", "courseReminders", value)}
                    label="Course Reminders"
                    description="Get reminded about upcoming courses and deadlines"
                  />
                  <ToggleSwitch
                    enabled={settings.notifications.achievementAlerts}
                    onChange={(value) => updateSetting("notifications", "achievementAlerts", value)}
                    label="Achievement Alerts"
                    description="Celebrate your achievements with notifications"
                  />
                  <ToggleSwitch
            ...
            {activeSection === "privacy" && (
              <SettingCard title="Privacy Settings" description="Control your privacy and data sharing preferences">
                <div className="space-y-6">
                  <div>
                    <label className="block text-white/80 text-sm font-medium mb-3">Profile Visibility</label>
                    <div className="space-y-2">
                      {[
                  ...
                  <div className="space-y-2">
                    ...
                    <ToggleSwitch
                      ...
                      onChange={(value) => updateSetting("privacy", "showAchievements", value)}
            ...
            {activeSection === "learning" && (
              <>
                <SettingCard title="Learning Goals" description="Set your daily and weekly learning targets">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <label className="block text-white/80 text-sm font-medium mb-2">Daily Goal (hours)</label>
                      <input
                        type="number"
                        min="0.5"
                        max="12"
                        ...
                        onChange={(e) => updateSetting("learning", "dailyGoal", Number.parseFloat(e.target.value))}
                    ...
                    <div>
                      <label className="block text-white/80 text-sm font-medium mb-2">Weekly Goal (hours)</label>
                      <input
                        type="number"
                        min="1"
                        max="50"
                        value={settings.learning.weeklyGoal}
                        onChange={(e) => updateSetting("learning", "weeklyGoal", Number.parseInt(e.target.value))}
                        className="w-full bg-white/10 border border-white/20 rounded-lg px-4 py-2 text-white focus:border-blue-400 focus:outline-none"
                      />
                    </div>
                  </div>
                ...
                <SettingCard title="Learning Preferences" description="Customize your learning experience">
                  <div className="space-y-6">
                    <div>
                      <label className="block text-white/80 text-sm font-medium mb-2">Difficulty Level</label>
                      <select
                    ...
                    <div className="space-y-2">
                      <ToggleSwitch
                        ...
                        onChange={(value) => updateSetting("learning", "autoplay", value)}
                        label="Autoplay Videos"
                        description="Automatically play the next video in a course"
                      />
                      <ToggleSwitch
                        enabled={settings.learning.subtitles}
                        onChange={(value) => updateSetting("learning", "subtitles", value)}
            ...
            {activeSection === "appearance" && (
              <SettingCard
                ...
                description="Customize the look and feel of your learning environment"
              >
                <div className="space-y-6">
                  <div>
            ...
            {activeSection === "data" && (
              <>
                <SettingCard title="Data Management" description="Manage your learning data and storage">
                  <div className="space-y-4">
                    <div className="flex items-center justify-between p-4 bg-white/5 rounded-lg border border-white/10">
                      <div>
                        <p className="text-white font-medium">Export Learning Data</p>
                        <p className="text-white/60 text-sm">Download all your progress, courses, and achievements</p>
                      </div>
                      <Button variant="outline" className="border-white/20 text-white hover:bg-white/10 bg-transparent">
                    ...
                    <div className="flex items-center justify-between p-4 bg-white/5 rounded-lg border border-white/10">
                      <div>
                        ...
                        <p className="text-white/60 text-sm">Clear stored data to free up space (2.3 GB)</p>
                      </div>
                      <Button variant="outline" className="border-white/20 text-white hover:bg-white/10 bg-transparent">
                ...
                <SettingCard title="Account Actions" description="Manage your account and data">
                  <div className="space-y-4">
            ...
            {activeSection === "help" && (
              <SettingCard title="Help & Support" description="Get help and contact our support team">
                <div className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <button className="flex items-center space-x-3 p-4 bg-white/5 rounded-lg border border-white/10 hover:bg-white/10 transition-all duration-200 text-left">
                      ...
                      <div>
                        ...
                        <p className="text-white/60 text-sm">Browse our comprehensive guides</p>
                      </div>
                    </button>
                    ...
                    <button className="flex items-center space-x-3 p-4 bg-white/5 rounded-lg border border-white/10 hover:bg-white/10 transition-all duration-200 text-left">
                      ...
                      <div>
                        ...
                        <p className="text-white/60 text-sm">Join our learning community</p>
                      </div>
                    </button>
                  </div>
                  ...
                  <div className="p-4 bg-blue-500/10 border border-blue-500/20 rounded-lg">
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <p className="text-blue-400 font-medium">Learnova v2.1.0</p>
                        <p className="text-white/60 text-sm mt-1">
                          You're using the latest version of Learnova. Check back regularly for updates and new
                          features.
                        </p>
                      </div>
                    </div>
